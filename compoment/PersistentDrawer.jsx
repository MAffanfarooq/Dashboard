...
import MailIcon from '@mui/icons-material/Mail'; // New icon
import EmailIcon from '@mui/icons-material/Email'; // New icon
import DraftsIcon from '@mui/icons-material/Drafts'; // New icon
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          {['Home', 'Profile', 'Notifications', 'Messages'].map((text, index) => (
        ...
        <Divider />
        <List>
          {['Email', 'Draft', 'Settings'].map((text, index) => (
            <ListItem key={text} disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                sx={[
                  {
              ...
              >
                ...
                >
                  {/* Apply specific icons */}
                  {text === 'Email' && <EmailIcon />}
                  {text === 'Draft' && <DraftsIcon />}
